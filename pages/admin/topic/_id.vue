<template>
    <v-card color="grey lighten-4" flat tile>
        ...
        <v-form v-model="valid" ref="form" lazy-validation>
            ...
            <v-card-actions>
                <v-spacer/>
                <v-btn color="green darken-1" flat @click="doSave" :disabled="submitStatus">更新</v-btn>
            </v-card-actions>
        </v-form>
    </v-card>
</template>
                  ...
                  if (fileInput == null) {
                    ...
                    fileInput.addEventListener('change', function () {
                      ...
                      axios({
                        ...
                        self.quill.pasteHTML(length, `<img src="${result.data.url}" width="1000" />`)
    ...
    methods: {
      ...
      doSave () {
        if (this.$refs.form.validate()) {
          ...
          axios.put('topic', this.topic).then(() => {
